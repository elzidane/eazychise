      ...
      <motion.div style={{ scale }} className="relative z-10 w-full grid lg:grid-cols-[1fr_1.05fr] gap-12 xl:gap-24 items-center">
        ...
        <motion.div style={{ y: yLeft }} className="mt-14 lg:mt-0">
          ...
          <motion.h1 initial={{ opacity:0, y:30 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.7, delay:0.1, ease:[0.16,1,0.3,1] }} className="h1-responsive mb-6">
            <span className="block text-[#111111] whitespace-normal md:whitespace-nowrap"><BlurText text="Bisnis" delay={120} animateBy="chars" /></span>
            <span className="relative block font-fraunces italic text-[#FF5C1A] py-1 whitespace-normal md:whitespace-nowrap">
              Kuliner &amp;
            ...
            <span className="block mt-1 whitespace-normal md:whitespace-nowrap" style={{ WebkitTextStroke:"2px #111111", color:"transparent" }}>
