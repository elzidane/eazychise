...
import { ArrowRight, Clock, Tag, TrendingUp, BookOpen, Calculator, ChevronRight } from "lucide-react";
    ...
    <main className="min-h-screen pt-28 pb-20 px-[5%]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h1 className="font-fraunces font-black text-[clamp(2.2rem,4vw,3.5rem)] text-[#111] leading-[1.08] mb-4">
