...
import { 
  ...
  Bookmark, TrendingUp, Coffee, ChevronRight, Star, Settings, Eye
} from "lucide-react";
        ...
        >
          ...
          <div className="flex items-center gap-3">
            {user.role === "franchisee" ? (
              ...
              <button
                className="flex items-center gap-2 bg-[#111] text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-[#333] hover:-translate-y-0.5 transition-all"
              >
                + Tambah Brand
              </button>
            )}
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl border border-black/5 hover:border-[#FF5C1A]/30 transition-colors">
                  ...
                  <button className="flex items-center justify-center p-2 rounded-xl bg-[#F8F8F6] text-[#555] hover:bg-[#111] hover:text-white transition-colors">
