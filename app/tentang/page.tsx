...
const timeline = [
  ...
  { year: "2024", title: "Riset Pasar", desc: "Survei ke 50+ calon franchisee dan 10+ brand franchise untuk memahami pain points utama di industri." },
      ...
      <section className="px-[5%] py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h1 className="font-fraunces font-black text-[clamp(2.5rem,5vw,4.5rem)] text-[#111] leading-[1.05] mb-6">
      ...
      <section className="px-[5%] py-20 bg-[#111111] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="font-fraunces font-black text-[clamp(2rem,3.5vw,3rem)] text-white leading-[1.08] mb-12">
      ...
      <section className="px-[5%] py-24 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="font-fraunces font-black text-[clamp(2rem,3.5vw,3rem)] text-[#111] leading-[1.08]">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="font-fraunces font-black text-[clamp(1.5rem,2.5vw,2.2rem)] text-white/90 leading-[1.3] italic">
      ...
      <section className="px-[5%] py-24 relative overflow-hidden">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-fraunces font-black text-[clamp(2rem,4vw,3.5rem)] text-[#111] leading-[1.08] mb-5">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://wa.me/6287792735999?text=Halo%20EazyChise%2C%20saya%20ingin%20tahu%20lebih%20lanjut"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 border-2 border-[#111]/15 text-[#333] px-8 py-4 rounded-full font-bold text-[0.95rem] hover:border-[#111] hover:-translate-y-0.5 transition-all"
              >
                Hubungi Kami
              </a>
            </div>
