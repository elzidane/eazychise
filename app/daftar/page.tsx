...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = () => {
    alert("🚀 Fitur Google Login segera hadir! Silakan daftar dengan email terlebih dahulu.");
  };
          ...
          <div className="bg-white p-8 sm:p-10 rounded-[40px] shadow-[0_32px_64px_rgba(0,0,0,0.06)] border border-black/5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative flex items-center py-4">
                ...
                <span className="flex-shrink-0 mx-4 text-gray-400 text-[0.65rem] font-bold uppercase tracking-[0.2em]">Atau daftar dengan</span>
                <div className="flex-grow border-t border-black/5"></div>
              </div>
